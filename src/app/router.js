...
const LazyCarousel = lazy(() =>
  import("../views/components/reactstrap/carousel")
);
    ...
    return (
      ...
      <BrowserRouter basename="/">
        <Switch>
          ...
          <MainLayoutRoutes
            exact
            path="/components/bootstrap/carousel"
            render={(matchprops) => (
              <Suspense fallback={<Spinner />}>
                <LazyCarousel {...matchprops} />
              </Suspense>
            )}
          />
          <MainLayoutRoutes
		  ...
		  <MainLayoutRoutes
                  exact
                  path="/components/extra/comment"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyCommentBox {...matchprops} />
                     </Suspense>
                  )}
               />
          <MainLayoutRoutes
