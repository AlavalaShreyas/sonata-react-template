    ...
    return (
      ...
      >
        ...
        {/* <SideMenu.MenuSingleItem badgeColor="danger" badgeText="6">
            ...
            <SideMenu.MenuSingleItem>
               <a
                  href="https://docs.SONATA-SOFTWARE-react.SONATA-SOFTWARE.com"
                  target="_blank"
            ...
            <SideMenu.MenuSingleItem>
               <a href="https://SONATA-SOFTWARE.ticksy.com" target="_blank" rel="noopener noreferrer" activeclassname="active">
                  <i className="menu-icon">
                     <LifeBuoy size={18} />
                  </i>
